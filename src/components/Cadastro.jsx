...
export default props =>{
    return(
        <View style={{flex:1, marginLeft: 20, marginRight: 20, justifyContent: 'space-around',backgroundColor: '#f0f0f0'}}>
            ...
            <Text style={styleLogin.txt}>Não possui uma conta? <TouchableOpacity onPress={() => props.navigation.navigate('Login')}><Text style={{color: '#f51313'}}>Cadastre-se aqui</Text></TouchableOpacity></Text>
        </View>
    )
}
